...
class DL(Utils):    
    ...
    def __init__(self):
        self.bucket = '20240920-matthew'#'20240912-hikaru-iceberg'
        print('Choose a Default Parameters Case: Default6Fx_64x64')
    ...
    def readData(self):
        ...
        if getDims == 4:
            ...
            self.OP[:,:,:,0] *= 1#self.params['scaleOP0']
            self.OP[:,:,:,1] *= 1#self.params['scaleOP1']
            ...
            # Apply scale
            self.FL *= self.params['scaleFL']
            self.OP[0,:,:,0] *= 1#self.params['scaleOP0']
            self.OP[0,:,:,1] *= 1#self.params['scaleOP1']
            self.DF *= self.params['scaleDF']
            self.QF *= self.params['scaleQF']
    ...
    def Model(self):
        ...
        self.modelD.compile(loss=['mse', 'mse'],
    ...
    def Analysis(self):
        ...
        print("Average Maximum Depth Error (SD) : {max_depth_error} ({max_depth_error_std})".format(max_depth_error = max_depth_error, max_depth_error_std = max_depth_error_std))
