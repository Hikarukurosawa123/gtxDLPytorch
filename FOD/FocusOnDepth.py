...
class FocusOnDepth(nn.Module):
    def __init__(self,
        ...
        #Transformer
        #oriignal - nhead = 12, 3D embed  = 16
        encoder_layer = nn.TransformerEncoderLayer(d_model=emb_dim, nhead=16, dropout=transformer_dropout, dim_feedforward=emb_dim*4, norm_first = False)
