...
class DL(Utils):    
    ...
    def Model(self):
        ...
        concat = concatenate([inFL],axis=-1)
        ...
        self.modelD = Model(inputs=[inOP_beg,inFL_beg], outputs=[outDF])#,outFL])
    ...
    def Fit(self,isTransfer):
        ...
        if isTransfer==True:
            ...
            self.history = self.modelD.fit([self.OP, self.FL], [self.DF],validation_split=0.2,batch_size=self.params['batch'],
